  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>{this.props.message} Call me {this.props.hint}</p>
      </div>
    )
  }
}

MyWebsiteChild.defaultProps = { message: "Hi I'm Spider-Man..", hint: "Spidey :)" }
  ...
  render() {
    return (
      <div>
        ...
        <button style={{ padding: "10px", margin: "3px", border: "0.5px solid yellow", borderRadius: "6px", cursor: "pointer" }} type='button' onClick={this.changeValue}>Exit</button>
      </div>
    )
  }
}
